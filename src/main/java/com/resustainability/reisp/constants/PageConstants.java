...
public class PageConstants {
	...
	public static final String compliants = "compliants";
	public static final String compliantsHistory = "compliantsHistory";
	public static final String bbBankView = "bbBankView";
	...
	public static final String cAdd = "irm";
