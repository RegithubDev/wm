...
public class User {
	...
	centerId
		      ...
		      createdBy,
		      createdDate,
		      modifiedBy,time_difference,
		      modifiedDate,complaintId, citizenName,circleName, complaintAddress, registrtionTypeId, transactionNo, transactionDate, complaintStatusId, 
		      citizenEmailId, closingTime, zoneId, circleId, wardId, areaId, locationId,locationCode, complaintTypeId, complaintDescription, binNumber, others, smsStatus,
...
;
	...
	public String getRegistrtionTypeId() {
		return registrtionTypeId;
	}

	public void setRegistrtionTypeId(String registrtionTypeId) {
		this.registrtionTypeId = registrtionTypeId;
	}
	...
	public String getCitizenEmailId() {
		return citizenEmailId;
	}

	public void setCitizenEmailId(String citizenEmailId) {
		this.citizenEmailId = citizenEmailId;
	}
	...
	public String getSecQueId() {
		return secQueId;
	}

	public void setSecQueId(String secQueId) {
