...
<body
						...
						<div class="col-12">
							...
							<div class="breadcrumb-wrapper">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active">Circle/Unit/Cluster</li>
								</ol>
							</div>
						</div>
					</div>
    ...
    <!-- Circle/Unit/Cluster Code -->
    <div class="col-lg-2 col-md-3 col-sm-6">
        <div class="form-group">
            <label for="circleCode">Circle/Unit/Cluster Code <span class="required">*</span></label>
            <input type="text" class="form-control" placeholder="">
        </div>
    </div>

    <!-- Circle/Unit/Cluster Name -->
    <div class="col-lg-2 col-md-3 col-sm-6">
        <div class="form-group">
            <label for="circleName">Circle/Unit/Cluster Name <span class="required">*</span></label>
            <input type="text" class="form-control" placeholder="">
        </div>
    </div>

    <!-- Search & Reset Buttons -->
  <div class="col-lg-2 col-md-3 col-sm-6 d-flex gap-2" style="
    margin-left: 11rem;
">
        <button class="btn btn-secondary" onclick="getcomplaintTypeIdList();">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel33">New Cluster Creation</h4>
      ...
      <form action="#">
        <div class="modal-body">
          ...
          <div class="mb-1">
            <input type="text" placeholder="Enter Circle/Unit/Cluster Code" class="form-control">
          </div>

          <!-- Circle/Unit/Cluster Name -->
          <label>Circle/Unit/Cluster Name <span class="required">*</span></label>
          <div class="mb-1">
            <input type="text" placeholder="Enter Circle/Unit/Cluster name" class="form-control">
          </div>
          
          <!-- Circle/Unit/Cluster Head -->
          <label>Circle/Unit/Cluster Head</label>
          <span class="required">*</span>
          <div class="mb-1">
            <select class="form-control">
              <option value="">--Select Circle/Unit/Cluster Head --</option>
              <option value="1">1</option>
              <option value="2">2</option>
              <!-- Add more options dynamically as needed -->
            </select>
    ...
    margin-left: -8rem;
">
        <button class="btn btn-success w-100" onclick="exportcomplaintTypeId();">
									...
									<table id="datatable-complaints"
										...
										<thead >
											<tr style="color : White; background-color : #66962c !important;">
												...
												<th scope="col">Circle/Unit/Cluster Code</th>											
												<th scope="col">Circle/Unit/Cluster Name</th>
												<th scope="col">Zone</th>		
												<th scope="col">Circle/Unit/Cluster Head</th>											
