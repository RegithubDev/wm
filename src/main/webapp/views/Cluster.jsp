		...
		<div class="content-wrapper container-xxl p-0">
			...
			<div class="content-body">
				...
				<section id="dashboard-analytics">
					...
					<div class="col-lg-6 col-sm-6 col-12" style="box-sizing: border-box; display: table;" data-select2-id="11">
...
<div class="form-group">
                ...
                <small class="error">.</small>
									...
									<div class="form-group">
                <label for="citizenName" class="" style="
    margin-left: -1rem;
">Circle/Unit/Cluster Code <span class="required">*</span></label>
                <input type="text" id="citizenName" name="citizenName" required="" style="
    width: 16rem;
    margin-left: -1rem;
">
                <small class="error">.</small>
...
">
                <label for="citizenName" class="" style="
    margin-left: -1rem;
">Circle/Unit/Cluster Name <span class="required">*</span></label>
                <input type="text" id="citizenName" name="citizenName" required="" style="
    width: 16rem;
    margin-left: -1rem;
">
