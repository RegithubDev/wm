...
<body>
    ...
    <nav>
        <div class="nav-wrapper blue darken-3">
            <div class="">
                <a href="<%=request.getContextPath() %>/home" class="brand-logo fs"><img src="<c:url value="/resources/images/logo/protect-main.png"/>" alt="Logo"> reirm</a>
        ...
        <div class="footer-copyright blue lighten-5 bottom">
            <div class="container">
                <!-- <span>Copyright 2020 @ mrvc.indianrailways.gov.in | Designed & Developed by</span> --> <img
                    src="<c:url value="/resources/images/logo/protect-main.png"/>" class="footer-img" alt="footer image">
            </div>
        </div>
    </div>
