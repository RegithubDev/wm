...
<body
						...
						<div class="col-12">
							...
							<div class="breadcrumb-wrapper">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active">ComplaintType</li>
								</ol>
							</div>
						</div>
					</div>
    ...
    <div class="col-lg-2 col-md-3 col-sm-6">
        <div class="form-group">
            <label for="complaintTypeCode">Complaint Type Code <span class="required">*</span></label>
            <input type="text" id="complaintTypeCode" name="complaintTypeCode" class="form-control" required>
        </div>
    </div>
    ...
    <div class="col-lg-2 col-md-3 col-sm-6">
        <div class="form-group">
            <label for="complaintTypeName">Complaint Type Name <span class="required">*</span></label>
            <input type="text" id="complaintTypeName" name="complaintTypeName" class="form-control" required>
        </div>
    </div>
...
">
    ...
    <!-- New & Export Buttons -->
    <div class="col-lg-3 col-md-3 col-sm-12 d-flex gap-2">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel33">New ComplaintType Creation</h4>
      ...
      <form action="#">
        <div class="modal-body">
          ...
          <!-- Complaint Type Code -->
          <label> Complaint Type Code <span class="required">*</span></label>
          <div class="mb-1">
            <input type="text" placeholder="Enter Complaint Type Code" class="form-control">
          </div>

          <!-- Complaint Type Name -->
          <label> Complaint Type Name <span class="required">*</span></label>
          <div class="mb-1">
            <input type="text" placeholder="Enter Complaint Type Name" class="form-control">
          </div>
									...
									<table id="datatable-complaints"
										...
										<thead >
											<tr style="color : White; background-color : #66962c !important;">
												...
												<th scope="col">ComplaintType Code</th>											
												<th scope="col">ComplaintType Name</th>
