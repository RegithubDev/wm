	...
	<div class="app-content content ">
		...
		<div class="content-wrapper container-xxl p-0">
			...
			<div class="content-body">
                ...
                <label for="citizenName" class="">ComplaintType code <span class="required">*</span></label>
                ...
                <small class="error">.</small>
						...
						<!--  	<div class="col-lg-6 col-sm-6 col-12"
								...
								<div class="col-lg-3 col-sm-3 col-6"
									...
									style="padding: 1rem; display: table-cell;">
									<div class="form-group">
                <label for="citizenName" class="">ComplaintType Name <span class="required">*</span></label>
                <input type="text" id="citizenName" name="citizenName" required="">
                <small class="error">.</small>
            </div>
									<h2 class="fw-bolder mt-1"></h2>
