...
<body
	...
	<div class="app-content content ">
		...
		<div class="row d-flex align-items-center" style="gap: 0.5rem;">

    <!-- Zone Code (3 units) -->
    <div class="col-lg-2 col-md-3 col-sm-6">
        <div class="form-group">
            <label for="zoneCode">Zone Code <span class="required">*</span></label>
            <input type="text" id="zoneCode" name="zoneCode" class="form-control" required>
        </div>
    </div>
    ...
    <div class="col-lg-2 col-md-3 col-sm-6">
        <div class="form-group">
            <label for="zoneName">Zone Name <span class="required">*</span></label>
            <input type="text" id="zoneName" name="zoneName" class="form-control" required>
        </div>
    </div>

    <!-- Search & Reset Buttons (2 units) -->
   <div class="col-lg-2 col-md-3 col-sm-6 d-flex gap-2 align-items-end" style="
    margin-left: 27rem;
    margin-top: 1rem;
">
    ...
    <!-- New Zone Button (2 units) -->
<div class="col-lg-2 col-md-3 col-sm-6 d-flex align-items-end" style="
    margin-left: -5rem;
    margin-top: 1rem;
">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel33">New Zone Creation</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="#">
        <div class="modal-body">
          <!-- Zone Code -->
          <label>Zone Code <span class="required">*</span></label>
          <div class="mb-1">
            <input type="text" placeholder="Enter Zone Code" class="form-control">
          </div>

          <!-- Zone Name -->
          <label>Zone Name <span class="required">*</span></label>
          <div class="mb-1">
            <input type="text" placeholder="Enter Zone Name" class="form-control">
          </div>
